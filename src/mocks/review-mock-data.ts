export const initialData = [
  {
    ...
    stars: 5,
    text:
      'Отличная площадка для проведения мастер-классов. Арендовал 250м2 с марта 2020 по декабрь. Современные планировки, надежные инженерные системы, профессиональная    управляющая компания. Всё устроило.',
    property: 'ул.Стахановская, 54 лит 3',
    photos: [
